...
> **STATUS UPDATE 2026-08-01 — Phase-1 fixes 3.1, 3.2, 3.3 and 3.5 are now
> IMPLEMENTED** (serve-side, no retrain; 131 tests pass, regressions pinned in
> `tests/test_phase1_fixes.py`). Their rows below are marked ✅ FIXED with what
> changed. 3.4 remains open and 3.6–3.10 are unchanged.
