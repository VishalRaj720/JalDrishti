...
|---|---|---|
| `ml_pipeline/` | **Production-grade.** 307 tests, exact-solution-benchmarked transport kernel, conformal bands validated on the serving distribution, drift monitor, 12-entry assumption register | **Keep — this is the crown jewel.** Frozen; see [`LIMITATIONS.md`](LIMITATIONS.md) |
...
These come from [`LIMITATIONS.md`](LIMITATIONS.md) §7 and
