...
# The report builder moved to `app/services/data_quality.py` (R16) so the API
# can compute it live; the seed keeps writing its JSON as a record of the run.
from app.services.data_quality import build_quality_report as _build_quality_report  # noqa: E402
