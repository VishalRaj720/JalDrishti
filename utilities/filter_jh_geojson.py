...
INPUT = os.path.join(os.path.dirname(__file__), "..", "Datasets", "District Boundary.geojson")
OUTPUT = os.path.join(os.path.dirname(__file__), "..", "Datasets", "District_Boundary_JH.geojson")
